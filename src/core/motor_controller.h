...
class MotorController {
	...
	private:
		...
		struct motor_data {
			...
			volatile uint32_t pulses_until_correction = 0;
			volatile uint32_t pulses_to_correct = 0;
			volatile uint32_t mcu_ticks_per_pulse = 0; 
			volatile uint32_t pulses_to_accel = 0;
			volatile uint32_t start_steps_delay = 0;
